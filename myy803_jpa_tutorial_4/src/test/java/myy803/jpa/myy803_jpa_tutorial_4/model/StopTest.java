...
public class StopTest {
    ...
    void setup(){
        ...
        route = new Route();
        syntagma = new Stop("Syntagma", 37.97569448870225, 23.73471989313159, route);
    ...
    void ensure_distance_from_self_is_zero(){
        ...
        Stop other = new Stop("Syntagma", 37.97569448870225, 23.73471989313159, route);
    ...
    void ensure_distance_from_approximates_fairly(){
        ...
        Stop oaka = new Stop("OAKA", 38.03605314932543, 23.786941787128843, route);
        // ~ 8.14km
